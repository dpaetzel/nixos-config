{
  ...
  "bar/bottom" = {
    ...
    modules-right = "wlan eth filesystem xkeyboard memory cpu battery0 battery1 date";
  ...
  "module/battery0" = {
    ...
    format-low-prefix = "BAT0 ";
    format-low-prefix-foreground = "\${colors.primary}";
    # Not sure why this doesn't work as expected.
    # ramp-capacity-0 = "!";
    # ramp-capacity-1 = "▃";
    # ramp-capacity-2 = "▄";
    # ramp-capacity-3 = "▅";
